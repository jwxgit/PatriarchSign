package com.jwx.patriarchsign.app.View.signpad.views;
...
import com.jwx.patriarchsign.app.View.signpad.utils.Bezier;
import com.jwx.patriarchsign.app.View.signpad.utils.ControlTimedPoints;
import com.jwx.patriarchsign.app.View.signpad.utils.SvgBuilder;
import com.jwx.patriarchsign.app.View.signpad.utils.TimedPoint;
import com.jwx.patriarchsign.app.View.signpad.view.ViewCompat;
import com.jwx.patriarchsign.app.View.signpad.view.ViewTreeObserverCompat;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                ensureSignatureBitmap();
                for (int i = 1; i <= 10; i++) {
                    mPaint.setStrokeWidth(mMaxWidth / 10f * i);
                    mSignatureBitmapCanvas.drawPoint(eventX - (10 - i), eventY - (10 - i), mPaint);
                }
                mPoints.clear();
...
//            System.out.println(startWidth + ttt * widthDelta);
